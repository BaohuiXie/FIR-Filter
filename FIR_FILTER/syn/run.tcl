...
analyze -format verilog {FIR_filter.v}
elaborate FIR_filter; # top module name

# store the unmapped results
write -hierarchy -format ddc -output results/FIR_filter.unmapped.ddc
...
source FIR_filter.constraints.tcl
...
check_design > reports/FIR_filter.check_design.rpt; # dump to the file
...
# Write out design
write -format verilog -hierarchy -output results/FIR_filter.mapped.v
write -format ddc -hierarchy -output results/FIR_filter.mapped.ddc
write_sdf results/FIR_filter.mapped.sdf
write_sdc -nosplit results/FIR_filter.mapped.sdc

# Generate reports
report_qor > reports/FIR_filter.mapped.qor.rpt
report_timing -transition_time -nets -attribute -nosplit \
  > reports/FIR_filter.mapped.timing.rpt
report_area -nosplit > reports/FIR_filter.mapped.area.rpt
report_power -nosplit > reports/FIR_filter.mapped.power.rpt
